...
: ${AMENT_CURRENT_PREFIX:="/root/jwq/xr/XRoboToolkit-Teleop-Sample-Python/install/jaka_robot_driver"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/jaka_robot_driver/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/jaka_robot_driver/environment/path.sh"
