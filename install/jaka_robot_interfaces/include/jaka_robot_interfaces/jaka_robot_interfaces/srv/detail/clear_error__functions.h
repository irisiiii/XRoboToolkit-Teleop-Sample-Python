...
#ifndef JAKA_ROBOT_INTERFACES__SRV__DETAIL__CLEAR_ERROR__FUNCTIONS_H_
#define JAKA_ROBOT_INTERFACES__SRV__DETAIL__CLEAR_ERROR__FUNCTIONS_H_
 ...
 * calls
 * jaka_robot_interfaces__srv__ClearError_Request__init().
...
/**
 * It calls
 * jaka_robot_interfaces__srv__ClearError_Request__fini()
 ...
 * jaka_robot_interfaces__srv__ClearError_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * jaka_robot_interfaces__srv__ClearError_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * jaka_robot_interfaces__srv__ClearError_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_jaka_robot_interfaces
...
/**
 * It calls
 * jaka_robot_interfaces__srv__ClearError_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_jaka_robot_interfaces
...
/**
 * It allocates the memory for the array and calls
 * jaka_robot_interfaces__srv__ClearError_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_jaka_robot_interfaces
...
/**
 * It calls
 * jaka_robot_interfaces__srv__ClearError_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // JAKA_ROBOT_INTERFACES__SRV__DETAIL__CLEAR_ERROR__FUNCTIONS_H_
