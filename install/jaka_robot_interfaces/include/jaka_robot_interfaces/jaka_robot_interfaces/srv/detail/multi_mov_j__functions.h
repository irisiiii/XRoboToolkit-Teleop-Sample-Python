...
#ifndef JAKA_ROBOT_INTERFACES__SRV__DETAIL__MULTI_MOV_J__FUNCTIONS_H_
#define JAKA_ROBOT_INTERFACES__SRV__DETAIL__MULTI_MOV_J__FUNCTIONS_H_
...
/// Initialize srv/MultiMovJ message.
/**
...
/// Finalize srv/MultiMovJ message.
/**
...
/// Create srv/MultiMovJ message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * jaka_robot_interfaces__srv__MultiMovJ_Request__init().
...
/// Destroy srv/MultiMovJ message.
/**
 * It calls
 * jaka_robot_interfaces__srv__MultiMovJ_Request__fini()
...
/// Check for srv/MultiMovJ message equality.
/**
...
/// Initialize array of srv/MultiMovJ messages.
/**
...
/// Finalize array of srv/MultiMovJ messages.
/**
 * It calls
 * jaka_robot_interfaces__srv__MultiMovJ_Request__fini()
...
/// Create array of srv/MultiMovJ messages.
/**
 * It allocates the memory for the array and calls
 * jaka_robot_interfaces__srv__MultiMovJ_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/MultiMovJ messages.
/**
 * It calls
 * jaka_robot_interfaces__srv__MultiMovJ_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/MultiMovJ message array equality.
/**
...
/// Copy an array of srv/MultiMovJ messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * jaka_robot_interfaces__srv__MultiMovJ_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_jaka_robot_interfaces
...
/**
 * It calls
 * jaka_robot_interfaces__srv__MultiMovJ_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_jaka_robot_interfaces
...
/**
 * It allocates the memory for the array and calls
 * jaka_robot_interfaces__srv__MultiMovJ_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_jaka_robot_interfaces
...
/**
 * It calls
 * jaka_robot_interfaces__srv__MultiMovJ_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // JAKA_ROBOT_INTERFACES__SRV__DETAIL__MULTI_MOV_J__FUNCTIONS_H_
